        ...
        <div className="footer-grid">
          ...
          <div className="footer-logo-section">
            ...
            <p className="footer-text">
              En canarias siempre encontrarás un destino al cual disfrutar al máximo con familia y amigos.
            </p>
          ...
          {/* Help links */}
          <div className="footer-links">
            <p className="footer-links-title">Help</p>
            <ul className="footer-links-list">
          ...
          <div className="footer-newsletter">
            <p className="footer-links-title">Subscribe to newsletter</p>
            <form>
              <div>
                <label htmlFor="email" className="sr-only">Email</label>
                <input type="email" id="email" placeholder="Enter your email" className="footer-input" />
              </div>
